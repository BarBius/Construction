        ...
        <div className="gallery">
            <div className="category">
                ...
                <div className="photos">
                    ...
                    <Link to="/contact" className="photo small-photo">
                        <img src="/public/istockphoto-941965912-612x612.jpg" alt="Top Plaquiste" />
            ...
            <div className="category">
                ...
                <div className="photos">
                    ...
                    <Link to="/contact" className="photo small-photo">
                        <img src="/public/creer-une-entreprise-de-maconnerie.png" alt="Savoir en plus" />
                        <div className="hover-text">Savoir en plus</div>
                    </Link>
                </div>
            </div>
            ...
            <div className="category">
                ...
                <div className="photos">
                    ...
                    <Link to="/contact" className="photo small-photo">
                        <img src="/public/pose-de-carrelage.jpg" alt="Savoir en plus" />
                        <div className="hover-text">Savoir en plus</div>
                    </Link>
                </div>
            </div>
            <div className="category">
                ...
                <div className="photos">
                    ...
                    <Link to="/contact" className="photo small-photo">
                        <img src="/public/Renovation-Diffazur.webp" alt="Design de piscine" />
                        <div className="hover-text">Savoir en plus</div>
                    </Link>
                </div>
            </div>
